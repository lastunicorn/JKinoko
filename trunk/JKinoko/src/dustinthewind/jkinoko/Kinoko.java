...
public class Kinoko {
	 ...
	 * 
	 * @param task
	 *            The task that is tested.
	 * @param repeateCount
	 *            The number of times the test is repeated. (To minimize the measurement errors.)
	 * @return The average time in milliseconds in which the task was run.
	 * @throws Exception
